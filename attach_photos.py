...
products_without_photo = Product.objects.filter(photo__isnull=True) | Product.objects.filter(photo="")
print(f"✓ Trouvé {products_without_photo.count()} produits sans photo")
