    ...
    <div className="fixed inset-0 z-50 overflow-y-auto bg-gray-900 bg-opacity-50">
      <div className="flex items-center justify-center min-h-screen p-4">
        <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
          ...
          <style>{`
            .proforma-print-readability { font-size: 19px; line-height: 1.5; color: #1e293b; }
            .proforma-print-readability .text-xs { font-size: 16px !important; }
            .proforma-print-readability .text-sm { font-size: 18px !important; }
            .proforma-print-readability .text-base { font-size: 20px !important; }
            .proforma-print-readability .text-lg { font-size: 22px !important; }
            .proforma-print-readability table { font-size: 18px !important; }
            .proforma-print-readability table th,
            .proforma-print-readability table td { font-size: 18px !important; }
            .proforma-print-readability .document-footer,
            .proforma-print-readability .document-footer * { font-size: 17px !important; }
            @media print {
              .proforma-print-readability { font-size: 15pt; }
            }
          `}</style>
        </div>
      </div>
