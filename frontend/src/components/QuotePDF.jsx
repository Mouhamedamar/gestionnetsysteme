...
const QuotePDF = ({ quote, onClose, autoDownload = false, silent = false }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-gray-900 bg-opacity-50">
      ...
      <style>{`
        .quote-print-readability { font-size: 19px; line-height: 1.5; color: #1e293b; }
        .quote-print-readability .text-xs { font-size: 16px !important; }
        .quote-print-readability .text-sm { font-size: 18px !important; }
        .quote-print-readability .text-base { font-size: 20px !important; }
        .quote-print-readability .text-lg { font-size: 22px !important; }
        .quote-print-readability table { font-size: 18px !important; }
        .quote-print-readability table th,
        .quote-print-readability table td { font-size: 18px !important; }
        .quote-print-readability .document-footer,
        .quote-print-readability .document-footer * { font-size: 17px !important; }
        @media print {
          .quote-page2 { page-break-before: always; }
          .quote-print-readability { font-size: 15pt; }
        }
      `}</style>
    </div>
  );
