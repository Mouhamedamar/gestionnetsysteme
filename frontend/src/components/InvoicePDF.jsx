  ...
  return (
    <div className={`fixed inset-0 z-50 overflow-y-auto animate-fade-in ${headless ? 'invisible pointer-events-none' : 'bg-slate-900/60 backdrop-blur-md'}`}>
      ...
      <style>{`
        ...
        .invoice-print-readability .text-xs { font-size: 16px !important; }
        .invoice-print-readability .text-sm { font-size: 18px !important; }
        .invoice-print-readability .text-base { font-size: 20px !important; }
        .invoice-print-readability .text-lg { font-size: 22px !important; }
        .invoice-print-readability table { font-size: 18px !important; }
        .invoice-print-readability table th { font-size: 18px !important; }
        .invoice-print-readability table td { font-size: 18px !important; }
        .invoice-print-readability .document-footer,
        .invoice-print-readability .document-footer * { font-size: 17px !important; }
        @media print {
          .no-print { display: none !important; }
          .invoice-page { page-break-after: always; }
          .invoice-page:last-child { page-break-after: auto; }
          .invoice-header-image img { max-height: 120px; }
          .invoice-print-readability { font-size: 15pt; }
          .invoice-print-readability .text-xs { font-size: 13pt !important; }
          .invoice-print-readability .text-sm { font-size: 14pt !important; }
          .invoice-print-readability .text-base { font-size: 15pt !important; }
          .invoice-print-readability table { font-size: 14pt !important; }
          .invoice-print-readability table th,
          .invoice-print-readability table td { font-size: 14pt !important; }
        }
